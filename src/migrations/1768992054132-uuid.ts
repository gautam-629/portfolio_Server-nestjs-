...
export class Uuid1768992054132 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "profile_pictures" DROP CONSTRAINT "PK_55851331ec0d252521dd1f7cde2"`,
    );
    await queryRunner.query(`ALTER TABLE "profile_pictures" DROP COLUMN "id"`);
    await queryRunner.query(
      `ALTER TABLE "profile_pictures" ADD "id" uuid NOT NULL DEFAULT uuid_generate_v4()`,
    );
    await queryRunner.query(
      `ALTER TABLE "profile_pictures" ADD CONSTRAINT "PK_55851331ec0d252521dd1f7cde2" PRIMARY KEY ("id")`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "profile_pictures" ADD "userId" integer`,
    );
    await queryRunner.query(
      `ALTER TABLE "profile_pictures" DROP CONSTRAINT "PK_55851331ec0d252521dd1f7cde2"`,
    );
    await queryRunner.query(`ALTER TABLE "profile_pictures" DROP COLUMN "id"`);
    await queryRunner.query(
      `ALTER TABLE "profile_pictures" ADD "id" SERIAL NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "profile_pictures" ADD CONSTRAINT "PK_55851331ec0d252521dd1f7cde2" PRIMARY KEY ("id")`,
    );
