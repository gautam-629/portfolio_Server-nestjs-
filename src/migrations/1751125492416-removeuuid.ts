...
export class Removeuuid1751125492416 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`profile_pictures\` DROP PRIMARY KEY`);
        await queryRunner.query(`ALTER TABLE \`profile_pictures\` DROP COLUMN \`id\``);
        await queryRunner.query(`ALTER TABLE \`profile_pictures\` ADD \`id\` int NOT NULL PRIMARY KEY AUTO_INCREMENT`);
        await queryRunner.query(`ALTER TABLE \`profile_pictures\` DROP COLUMN \`userId\``);
        await queryRunner.query(`ALTER TABLE \`profile_pictures\` ADD \`userId\` int NULL`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`profile_pictures\` DROP COLUMN \`userId\``);
        await queryRunner.query(`ALTER TABLE \`profile_pictures\` ADD \`userId\` varchar(36) NULL DEFAULT 'NULL'`);
        await queryRunner.query(`ALTER TABLE \`profile_pictures\` DROP COLUMN \`id\``);
        await queryRunner.query(`ALTER TABLE \`profile_pictures\` ADD \`id\` varchar(36) NOT NULL`);
        await queryRunner.query(`ALTER TABLE \`profile_pictures\` ADD PRIMARY KEY (\`id\`)`);
        await queryRunner.query(`ALTER TABLE \`profile_pictures\` ADD CONSTRAINT \`FK_980eb704bc96af9ee797c66dfc3\` FOREIGN KEY (\`userId\`) REFERENCES \`users\`(\`id\`) ON DELETE CASCADE ON UPDATE CASCADE`);
    }
